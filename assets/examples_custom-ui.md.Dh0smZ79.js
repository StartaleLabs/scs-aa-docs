import{_ as i,c as a,o as n,ae as t}from"./chunks/framework.Dh1jimFm.js";const o=JSON.parse('{"title":"Creating a custom UI for the demo app","description":"","frontmatter":{},"headers":[],"relativePath":"examples/custom-ui.md","filePath":"examples/custom-ui.md"}'),l={name:"examples/custom-ui.md"};function e(p,s,h,k,r,E){return n(),a("div",null,s[0]||(s[0]=[t(`<h1 id="creating-a-custom-ui-for-the-demo-app" tabindex="-1">Creating a custom UI for the demo app <a class="header-anchor" href="#creating-a-custom-ui-for-the-demo-app" aria-label="Permalink to &quot;Creating a custom UI for the demo app&quot;">​</a></h1><p>This section details the core technologies, smart contracts, and SDKs used in the demo so you can create your own custom interface.</p><h2 id="key-libraries-and-sdks" tabindex="-1">Key Libraries and SDKs <a class="header-anchor" href="#key-libraries-and-sdks" aria-label="Permalink to &quot;Key Libraries and SDKs&quot;">​</a></h2><ul><li><code>rhinestone/module-sdk</code>, for interaction with ERC-7579 modules <ul><li>NOTE: for compatibility reasons, the module version is locked to <code>0.2.3</code></li></ul></li><li><code>@biconomy/abstractjs</code> instantiate and manage Nexus accounts</li><li><code>viem</code> for SC interaction from TS</li><li><code>@privy-io/react-auth</code> for interaction with Privy social login features</li></ul><h2 id="smart-contracts-on-soneium-minato" tabindex="-1">Smart Contracts on Soneium Minato <a class="header-anchor" href="#smart-contracts-on-soneium-minato" aria-label="Permalink to &quot;Smart Contracts on Soneium Minato&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  # Standard entrypoint v0.7.0 address</span></span>
<span class="line"><span>  ENTRY_POINT_ADDRESS=0x0000000071727De22E5E9d8BAf0edAc6f37da032</span></span>
<span class="line"><span></span></span>
<span class="line"><span>  # Nexus smart contract wallet related contracts</span></span>
<span class="line"><span>  ACCOUNT_RECOVERY_MODULE_ADDRESS=0xA04D053b3C8021e8D5bF641816c42dAA75D8b597</span></span>
<span class="line"><span>  NEXUS_K1_VALIDATOR_ADDRESS=0x9130927806aC54F93Feb58Eb459c08dcA7D116F8</span></span>
<span class="line"><span>  NEXUS_K1_VALIDATOR_FACTORY_ADDRESS=0x2ecd86799137FA35De834Da03D876bcc363ec0c3</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> });</span></span></code></pre></div><h3 id="_3-create-a-nexus-smart-account-and-a-client" tabindex="-1">3. <strong>Create a Nexus Smart Account and a client</strong> <a class="header-anchor" href="#_3-create-a-nexus-smart-account-and-a-client" aria-label="Permalink to &quot;3. **Create a Nexus Smart Account and a client**&quot;">​</a></h3><ul><li>Utilize <code>@biconomy/abstractjs</code> to instantiate a smart account.</li><li>Use <code>window.ethereum</code> provider as a signer</li><li>for backend use a different <code>signer</code> instance (f.ex. <code>viem</code>&#39;s local wallet)</li><li>use <code>createSmartAccountClient</code> for further interaction with the account</li></ul><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">type</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> NexusAccount, </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">type</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> NexusClient, createSmartAccountClient, toNexusAccount } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;@biconomy/abstractjs&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> });</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> // Create a Nexus account</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> nexusAccountInstance</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> await</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> toNexusAccount</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   attesters: [</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">MOCK_ATTESTER_ADDRESS</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">],</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   factoryAddress: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">NEXUS_K1_VALIDATOR_FACTORY_ADDRESS</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   validatorAddress: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">NEXUS_K1_VALIDATOR_ADDRESS</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   index: </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">BigInt</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">), </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//Nonce for account instance</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> });</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> nexusClientInstance</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> createSmartAccountClient</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     account: nexusAccount,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     transport: </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">http</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">BUNDLER_URL</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">),</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     client: publicClient,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">            };</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">          },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        }</span></span></code></pre></div></div><h3 id="_4-install-social-recovery-module-optional" tabindex="-1">4. <strong>Install Social Recovery Module (Optional)</strong> <a class="header-anchor" href="#_4-install-social-recovery-module-optional" aria-label="Permalink to &quot;4. **Install Social Recovery Module (Optional)**&quot;">​</a></h3><ul><li><p>Set up recovery guardians using <code>getSocialRecoveryValidator</code> from <code>@rhinestone/module-sdk</code>.</p></li><li><p>Install it via the <code>nexusClient.installModule()</code> function.</p><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> installModuleUserOpHash</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> await</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusClient.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">installModule</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">];</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> addGuardianUserOpHash</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> await</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusClient.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sendUserOperation</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  callData: </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">await</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusClient.account.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">encodeCalls</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(calls),</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">];</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> removeGuardianUserOpHash</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> await</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusClient.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sendUserOperation</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  callData: </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">await</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusClient.account.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">encodeCalls</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(calls),</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  args: [nexusClient.account.address],</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     account: nexusClient.account,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     signer: sessionOwner,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   });</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">   const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> nexusSessionClient</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusClient.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">extend</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">smartSessionCreateActions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(sessionsModule));</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">   ];</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">   const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> createSessionsResponse</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> await</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> nexusSessionClient.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">grantPermission</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     granter: nexusClient.account.address,</span></span>
